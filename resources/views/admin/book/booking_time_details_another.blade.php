                ...
                <td>
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" role="menu">
                            ...
                            <a class="dropdown-item mark-failed-btn-one" href="#" data-id="{{ $book->id }}">Failed</a>
                            <div class="dropdown-divider"></div>
                        </div>
                    </div>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" role="menu">
                            <form action="{{ route('addBooking') }}" method="post">
                                ...
                                <input type="hidden" name="city" value="Abu Dhabi">
...
<script>
    $(document).ready(function() {
        ...
        $('.mark-failed-btn-one').on('click', function(event) {
