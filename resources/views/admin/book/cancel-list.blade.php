<x-admin-app-layout>
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Booking Cancel List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Booking Cancel List</li>
                    </ol>
                </div>
            </div>
        </div>
                                            ...
                                            <a href="{{ route('admin.order.create', $order->order_code) }}" class="font-weight-bold">
                                                ...
                                                @if($order->status=='pending')
                                                    ...
                                                    @if($order->OrderItems->count() && $order->order_total != null)
                                                        ...
                                                        <a href="{{ route('admin.book.send-admin', $order->order_code) }}" class="font-weight-bold">
                                                            Admin |
                                                        </a>
                                                        @if($order->mail_send=='pending')
                                                        <a href="{{ route('admin.book.send-user', $order->order_code) }}" class="font-weight-bold">
                                                            User |
                                                        </a>
                                                        @else
                                                        <a href="{{ route('admin.book.send-user', $order->order_code) }}" class="font-weight-bold text-success">
