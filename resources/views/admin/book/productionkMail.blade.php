...
<body>
    ...
    <p style="margin-top:30px;font-size:15px;margin-bottom:30px;">Thank you for your payment. We’re happy to confirm that your order ID: [{{ $data->order_code }}] is now in production.
    </span></p>
    
    <p style="margin-top:10px;font-size:15px;">Once it’s ready, we’ll send you a quick link to schedule your installation.</p>
   
    
    
    <p style="margin-top:10px;font-size:15px;color:#053669;">If you need anything in the meantime, feel free to reach out!</p>
