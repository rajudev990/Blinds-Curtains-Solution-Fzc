...
<body>
    ...
    <p style="margin-top:30px;font-size:16px;margin-bottom:30px;">We hope you are enjoying your new blinds/curtains. This is a friendly reminder that the remaining balance for your order {{ $data->order_code }} is still outstanding.</p>
    
   <p style="margin-top:10px;font-size:16px;">Please use the link below to complete your payment at your earliest convenience:</p>
    
    
    <p style="margin-top:30px;font-size:15px;margin-bottom:30px;color:#fff !important;"><a style="color: #fff !important;" class="btn-payment" href="{{ route('admin.order.checkout',$data->order_code) }}">Click Here To Pay Online</a></p>
    
   <p style="margin-top:10px;font-size:16px;">For your reference, you can view your invoice here: <br><br> <a style="color: #fff !important;" class="btn-payment" href="{{ route('admin.order.invoice',$data->order_code) }}">Invoice</a></p>
