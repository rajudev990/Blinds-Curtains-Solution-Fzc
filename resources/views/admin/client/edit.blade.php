...
@endsection
    ...
    <section class="content pt-5">
        ...
        <div class="container-fluid">
            <form action="{{ route('admin.happy-client.update', $data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <img class="mt-3" src="{{ Storage::url($data->image) }}"
                                                id="image" alt="your footer_logo" width="150" height="70"
                                                style="border:1px dashed black">
                                            @else
                                            <img class="mt-3 d-none" src="" id="image" alt="your footer_logo"
                                                width="150" height="70" style="border:1px dashed black">
                                            @endif
                                        </div>
                                    </div>
