<x-admin-app-layout>
    @section('title')
    Edit Different Fabric
    @endsection
    <!-- Main content -->
    <section class="content pt-5">
        <!-- Default box -->
        <div class="container-fluid">
            <form action="{{ route('admin.different-fabric.update', $data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-lg-7 m-auto">
                        <div class="card">
                            ...
                            <div class=" card-footer d-flex justify-content-end bg-white pb-5">
                                ...
                                <a href="{{ route('admin.different-fabric.index') }}" class="btn btn-outline-dark custom-btn">Cancel</a>
