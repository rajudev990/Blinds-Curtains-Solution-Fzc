            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ route('admin.help.create') }}" class="btn btn-primary custom-btn">Add Help</a>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span>{{ $item?->help_title->name }}</span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('admin.help.edit',$item->id) }}">
        ...
        function deleteData(id) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: "{{ url('admin/help') }}" + '/' + id, // Constructing the URL with the id
                            type: "POST",
                            data: {
                                '_method': 'DELETE',
                                '_token': csrf_token
