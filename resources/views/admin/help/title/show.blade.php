<x-admin-app-layout>
    @section('title') View Help Title @endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="pb-5 pt-3 d-flex justify-content-end">
                                            ...
                                            <a href="{{ route('admin.help-title.edit',$data->id) }}" class="btn btn-primary ml-3 custom-btn" style="color: white !important;">Edit</a>
                                        </div>
                                    </div>
