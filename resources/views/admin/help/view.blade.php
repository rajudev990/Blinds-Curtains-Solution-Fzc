                    ...
                    <div class="col-lg-7 m-auto">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <select name="question" id="question" class="form-control" disabled>
                                                @foreach($list as $item)
                                                    <option value="{{ $item->id }}" {{ $data->question == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                @endforeach
                            ...
                            <div class=" card-footer d-flex justify-content-end bg-white pb-5">
                                ...
                                <a href="{{ route('admin.help.edit',$data->id) }}"
