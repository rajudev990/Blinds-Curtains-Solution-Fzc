                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu" style="">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('admin.order.confirm',$item->id) }}"><i class="fa fa-check-circle"></i> Confirm</a>
                                                    <div class="dropdown-divider"></div>
                                            ...
                                            <div>
                                                @if($item->status==='payment')
                                                    <span class="text-success">Customer Payment Successfully</span> <br>
