<x-admin-app-layout>
@section('title') Show Different Curtains Styles @endsection
    <!-- Main content -->
                    ...
                    <div class="col-lg-7 m-auto">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="description" id="description" cols="30" rows="8" readonly disabled>{!! $data->description !!}</textarea required >
                            ...
                            <div class=" card-footer d-flex justify-content-end bg-white pb-5">
                                ...
                                <a href="{{ route('admin.our-blog.index') }}"
                                class="btn btn-outline-dark custom-btn">Back</a>
                                <a href="{{ route('admin.our-blog.edit',$data->id) }}"
