<x-admin-app-layout>
@section('title') Pages Show @endsection
    <!-- Main content -->
                    ...
                    <div class="col-lg-7 m-auto">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class=" summernote form-control" name="content" id="content" cols="30" rows="3" readonly disabled>{!! $data->content !!}
                                            </textarea required >
                            ...
                            <div class=" card-footer d-flex justify-content-end bg-white pb-5">
                                ...
                                <a href="{{ route('admin.pages.edit',$data->id) }}"
