<x-admin-app-layout>
    ...
    <section class="content pt-5">
        ...
        <div class="container-fluid">
            <form id="validation-form" action="{{ route('admin.page-numbers.store') }}" method="post">
                @csrf
                @method('post')
                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <select name="catalouge_book_id" id="catalouge_book_id" class="form-control select2 @error('catalouge_book_id')
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            is-invalid @enderror" placeholder="Page Number" required>
                                            @error('name')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
