                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input value="{{ $data->name }}" type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Name">
                                            @error('name')
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="custom-file">
                                                <input value="{{ $data->image }}" name="image" type="file" class="custom-file-input" id="customFile" onchange="document.getElementById('image').src = window.URL.createObjectURL(this.files[0]);$('#image').addClass('d-block')">
                                            ...
                                            @if( $data->image !=null)
                                            <img class="mt-3" src="{{ Storage::url($data->image) }}" id="image" alt="your footer_logo" width="50" height="50" style="border:1px dashed black">
                                            @else
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="custom-file">
                                                <input value="{{ $data->meta_image }}" name="meta_image" type="file" class="custom-file-input" id="customFile" onchange="document.getElementById('meta_image').src = window.URL.createObjectURL(this.files[0]);$('#meta_image').addClass('d-block')">
                                                <label class="custom-file-label" for="customFile">Choose file</label>
                                                @error('meta_image')
                                                <div role="alert" class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            <img class="mt-3" src="{{ Storage::url($data->meta_image) }}" id="meta_image" alt="your footer_logo" width="50" height="50" style="border:1px dashed black">
                                            @else
