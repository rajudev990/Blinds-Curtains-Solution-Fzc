<x-admin-app-layout>
    @section('title') Edit Project Highlight @endsection
    <!-- Main content -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input value="{{ $data->title }}" type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="title" required>
                                            @error('title')
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                                ...
                                                <input value="{{ $data->video }}" onchange="showVideoPreview(this)" type="text" name="video" id="videoInput" class="form-control @error('video') is-invalid @enderror" placeholder="Video link" required>
                                                @error('video')
                                                <div role="alert" class="text-danger">
                                                    <strong>{{ $message }}</strong>
                                                </div>
