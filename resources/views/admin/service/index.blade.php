    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('admin.services.create') }}" class="btn btn-primary custom-btn">Add New Services</a>
            </div>
            <div class="card">
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->title }}</td>
                                <td>
                                    <img src="{{ asset('storage/'.$item->image) }}" alt="Banner image" width="75px">
        ...
        function deleteData(id) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: "{{ url('admin/services') }}" + '/' + id, // Constructing the URL with the id
                            type: "POST",
                            data: {
                                '_method': 'DELETE',
                                '_token': csrf_token
