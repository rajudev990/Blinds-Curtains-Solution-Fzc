<x-admin-app-layout>
@section('title') Show Services @endsection
    <!-- Main content -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="short_description" id="short_description" cols="30" rows="3" readonly disabled>{!! $data->short_description !!}
                                            </textarea required >
