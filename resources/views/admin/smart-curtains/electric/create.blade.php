<x-admin-app-layout>
@section('title')
    Add New Electric Curtains
@endsection
    <!-- Main content -->
    <section class="content pt-5">
        <!-- Default box -->
        <div class="container-fluid">
            <form id="validation-form" action="{{ route('admin.electric-curtains.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                <div class="row">
                    <div class="col-lg-7 m-auto">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex justify-content-end bg-white pb-5">
                                ...
                                <a href="{{ route('admin.electric-curtains.index') }}" class="btn btn-outline-dark custom-btn">Cancel</a>
