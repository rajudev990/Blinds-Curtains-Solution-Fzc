...
@endphp
    ...
    <section class="content pt-5">
        ...
        <div class="container-fluid">
            <form id="validation-form" action="{{ route('admin.life-styles.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                <div class="row">
                    <div class="col-lg-7 m-auto">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex justify-content-end bg-white pb-5">
                                ...
                                <a href="{{ route('admin.life-styles.index') }}" class="btn btn-outline-dark custom-btn">Cancel</a>
