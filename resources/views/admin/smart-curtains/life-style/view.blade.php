                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="title">Title Head</label>
                                        <select name="title_id" id="title_id" class="form-control" required readonly="">
                                            @foreach($list as $item)
                                                <option value="{{ $item->id }}" {{ $data->title_id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class=" card-footer d-flex justify-content-end bg-white pb-5">
                                ...
                                <a href="{{ route('admin.life-styles.index') }}"
                                class="btn btn-outline-dark custom-btn">Back</a>
                                <a href="{{ route('admin.life-styles.edit',$data->id) }}"
