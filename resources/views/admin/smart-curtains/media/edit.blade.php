<x-admin-app-layout>
@section('title')
   Edit Smart Curtains Media
@endsection
    <!-- Main content -->
    <section class="content pt-5">
        <!-- Default box -->
        <div class="container-fluid">
            <form action="{{ route('admin.smart-curtains-media.update', $data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-lg-7 m-auto">
                        <div class="card">
                            ...
                            <div class=" card-footer d-flex justify-content-end bg-white pb-5">
                                ...
                                <a href="{{ route('admin.smart-curtains-media.index') }}"
