            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ route('admin.our-team.create') }}" class="btn btn-primary custom-btn">Add New Teams</a>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>
                                            <img src="{{ Storage::url($item->image) }}" alt="Banner image" width="130px" height="130px">
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.our-team.show',$item->id) }}">
        ...
        function deleteData(id) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: "{{ url('admin/our-team') }}" + '/' + id, // Constructing the URL with the id
                            type: "POST",
                            data: {
                                '_method': 'DELETE',
                                '_token': csrf_token
