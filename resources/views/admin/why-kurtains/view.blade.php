<x-admin-app-layout>
@section('title') Show Why Blinds & Curtains Solution Fzc @endsection
@php
                    ...
                    <div class="col-lg-7 m-auto">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <select name="why_kurtains" id="why_kurtains" class="form-control" disabled>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if ($data->image != null)
                                                <img class="mt-3" src="{{ Storage::url($data->image) }}"
                                                    id="image" alt="your footer_logo" width="250" height="120"
                                                    style="border:1px dashed black">
                                            @else
                                                <img class="mt-3 d-none" src="" id="image"
                                                    alt="your footer_logo" width="250" height="120"
                                                    style="border:1px dashed black">
                                            @endif
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="description" id="description" cols="30" rows="7" readonly disabled>{!! $data->description !!}
                                            </textarea required >
                            ...
                            <div class=" card-footer d-flex justify-content-end bg-white pb-5">
                                ...
                                <a href="{{ route('admin.why-kurtains.index') }}"
                                class="btn btn-outline-dark custom-btn">Back</a>
                                <a href="{{ route('admin.why-kurtains.edit',$data->id) }}"
