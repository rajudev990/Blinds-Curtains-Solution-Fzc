<x-admin-app-layout>
    ...
    <section class="content pt-5">
        ...
        <div class="container-fluid">
            <form id="validation-form" action="{{ route('admin.opening.update', $data->id) }}" method="post">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-lg-7 m-auto">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input readonly type="text" name="name" id="title" class="form-control @error('name')
                                            is-invalid @enderror"
                            ...
                            <div class="card-footer d-flex justify-content-end bg-white pb-5">
                                ...
                                <a href="{{ route('admin.opening.index') }}"
                                    class="btn btn-outline-dark custom-btn">Cancel</a>
                                
                                    <a href="{{ route('admin.opening.edit',$data->id) }}"
