...
<body>
    ...
    <p style="margin-top:30px;font-size:16px;margin-bottom:30px;">We regret to inform you that despite previous reminders, the outstanding balance for your order ID: {{ $order->order_code }} remains unpaid. As a result, we are compelled to issue a formal legal notice.</p>
    
   <p style="margin-top:10px;font-size:16px;">Immediate payment is required to avoid further legal action and additional fees. You can settle the balance using the following link:</p>
    ...
    <p style="margin-top:30px;font-size:15px;margin-bottom:30px;color:#fff !important;"><a style="color: #fff !important;" class="btn-payment" href="{{ route('admin.order.checkout',$order->order_code) }}">Click Here To Pay Online</a></p>
     ...
     <p style="margin-top:25px;font-size:16px;color:#053669;">For any questions or to discuss this matter, please contact us urgently.</p>
