...
<body>
    ...
    <p style="margin-top:30px;font-size:16px;margin-bottom:30px;">We hope you are enjoying your new blinds/curtains. This is a friendly reminder that the remaining balance for your order ID: {{ $order->order_code }} is still outstanding.</p>
    
   <p style="margin-top:10px;font-size:16px;">Please use the following link to complete your payment at your earliest convenience:</p>
   ...
   <p style="margin-top:10px;font-size:16px;">For your reference, you can view your invoice here: <br><br><a style="color: #fff !important;" class="btn-payment" href="{{ route('admin.order.invoice',$order->order_code) }}">Invoice</a></p>
     ...
     <p style="margin-top:25px;font-size:16px;color:#053669;">If you have any questions or need assistance, please feel free to contact us. Thank you for your prompt attention to this matter.</p>
